...
public class BasePluscommissionEmployees extends Employees {
	...
	public BasePluscommissionEmployees(int grossSales, float commissionRate, float baseSalary, float bonus,String socialSecurityNumber, String firstName, String lastName, Date birthday,
